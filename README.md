...
* soit ajouter en copiant-collant l'url https://raw.githubusercontent.com/aldarion-jdr/sfrpg-fr-translation/v9/module.json dans la partie basse `URL du Manifest` et cliquer sur `installation` en bas à droite.
